...
},{"../utils":"72Dku","@studio-freight/lenis":"jOD5W","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"jOD5W":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function i(t1, o1) {
    return i = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t, o) {
...
var r = /*#__PURE__*/ function(t2) {
    var r1, e1;
    function l1(i1) {
        var r2, e, l, n, s = void 0 === i1 ? {} : i1, c = s.lerp, d = void 0 === c ? .1 : c, h = s.smooth, a = void 0 === h || h, u = s.direction, f = void 0 === u ? "vertical" : u;
        (n = t2.call(this) || this).onResize = function(t) {
            var o = t[0];
            if (o) {
                var i2 = o.contentRect;
                n.limit = "horizontal" === n.direction ? i2.width - n.windowWidth : i2.height - n.windowHeight;
            }
        }, n.onWindowResize = function() {
            n.windowHeight = window.innerHeight, n.windowWidth = window.innerWidth;
        }, n.onVirtualScroll = function(t) {
            var o = t.deltaY, i3 = t.originalEvent;
            n.stopped ? i3.preventDefault() : (n.smooth && !i3.ctrlKey && i3.preventDefault(), n.targetScroll -= o, n.targetScroll = Math.max(0, Math.min(n.targetScroll, n.limit)));
        }, n.onScroll = function(t) {
            if (!(n.stopped || n.scrolling && n.smooth)) {
                var o = n.scroll;
                n.targetScroll = n.scroll = "horizontal" === n.direction ? window.scrollX : window.scrollY, n.velocity = n.scroll - o, n.notify();
            }
        }, n.lerp = d, n.smooth = a, n.direction = f, window.addEventListener("scroll", n.onScroll, !1), window.addEventListener("resize", n.onWindowResize, !1);
        var v = (null == (r2 = navigator) || null == (e = r2.userAgentData) ? void 0 : e.platform) || (null == (l = navigator) ? void 0 : l.platform) || "unknown";
        return n.virtualScroll = new (0, _virtualScrollDefault.default)({
            firefoxMultiplier: 50,
            mouseMultiplier: v.indexOf("Win") > -1 ? 1 : .4,
            useKeyboard: !1,
            useTouch: !1,
            passive: !1
        }), n.virtualScroll.on(n.onVirtualScroll), n.onWindowResize(), n.limit = "horizontal" === n.direction ? document.body.offsetWidth - n.windowWidth : document.body.offsetHeight - n.windowHeight, n.resizeObserver = new ResizeObserver(n.onResize), n.resizeObserver.observe(document.body), n.targetScroll = n.scroll = "horizontal" === n.direction ? window.scrollX : window.scrollY, n.velocity = 0, n;
    }
    e1 = t2, (r1 = l1).prototype = Object.create(e1.prototype), r1.prototype.constructor = r1, i(r1, e1);
    var n1 = l1.prototype;
    return n1.start = function() {
        this.stopped = !1;
    }, n1.stop = function() {
        this.stopped = !0;
    }, n1.destroy = function() {
        ...
        if (!this.stopped && this.smooth) {
            var t, o = this.scroll;
            this.scroll = (1 - (t = this.lerp)) * this.scroll + t * this.targetScroll, Math.round(this.scroll) === Math.round(this.targetScroll) && (this.scroll = o = this.targetScroll), this.velocity = this.scroll - o, this.scrolling && ("horizontal" === this.direction ? window.scrollTo(this.scroll, 0) : window.scrollTo(0, this.scroll), this.notify()), this.scrolling = this.scroll !== this.targetScroll;
        }
    }, n1.notify = function() {
        this.emit("scroll", {
            scroll: this.scroll,
    ...
    }, n1.scrollTo = function(t, o) {
        var i4, r3 = (void 0 === o ? {} : o).offset, e = void 0 === r3 ? 0 : r3;
        if ("number" == typeof t) i4 = t;
        else if ("top" === t) i4 = 0;
        else if ("bottom" === t) i4 = this.limit;
        else {
            var l;
            if ("string" == typeof t) l = document.querySelector(t);
            else {
            ...
            i4 = ("horizontal" === this.direction ? n.left : n.top) + this.scroll;
        }
        this.targetScroll = i4 += e, this.scrolling = !0, this.smooth || (this.scroll = i4, "horizontal" === this.direction ? window.scrollTo(this.scroll, 0) : window.scrollTo(0, this.scroll));
    }, l1;
...
!function(e, t) {
    ...
    var o1 = n1;
    o1.TinyEmitter = n1;
    var s1, h1 = "virtualscroll", r = t1("options"), a = t1("el"), l = t1("emitter"), u = t1("event"), c = t1("touchStart"), d = t1("bodyTouchAction");
    return function() {
        function e2(e3) {
            var t = this;
            Object.defineProperty(this, r, {
                ...
                var n = i1(t, r)[r], o = i1(t, u)[u];
                o.deltaX = e.wheelDeltaX || -1 * e.deltaX, o.deltaY = e.wheelDeltaY || -1 * e.deltaY, s1.isFirefox && 1 === e.deltaMode && (o.deltaX *= n.firefoxMultiplier, o.deltaY *= n.firefoxMultiplier), o.deltaX *= n.mouseMultiplier, o.deltaY *= n.mouseMultiplier, t._notify(e);
                ...
                i1(t, c)[c].x = n.pageX, i1(t, c)[c].y = n.pageY;
            }, this._onTouchMove = function(e) {
                var n = i1(t, r)[r];
                n.preventTouch && !e.target.classList.contains(n.unpreventTouchClass) && e.preventDefault();
                var o = i1(t, u)[u], s = e.targetTouches ? e.targetTouches[0] : e;
                o.deltaX = (s.pageX - i1(t, c)[c].x) * n.touchMultiplier, o.deltaY = (s.pageY - i1(t, c)[c].y) * n.touchMultiplier, i1(t, c)[c].x = s.pageX, i1(t, c)[c].y = s.pageY, t._notify(e);
                ...
                t._notify(e);
            }, i1(this, a)[a] = window, e3 && e3.el && (i1(this, a)[a] = e3.el, delete e3.el), s1 || (s1 = {
                ...
                useKeyboard: !0,
                useTouch: !0
            }, e3), i1(this, l)[l] = new o1, i1(this, u)[u] = {
                y: 0,
                x: 0,
                deltaX: 0,
                deltaY: 0
                ...
                x: null,
                y: null
            }, i1(this, d)[d] = null, void 0 !== i1(this, r)[r].passive && (this.listenerOptions = {
                passive: i1(this, r)[r].passive
            });
        }
        var t2 = e2.prototype;
        return t2._notify = function(e) {
            var t = i1(this, u)[u];
            t.x += t.deltaX, t.y += t.deltaY, i1(this, l)[l].emit(h1, {
                x: t.x,
                y: t.y,
                deltaX: t.deltaX,
                deltaY: t.deltaY,
            ...
            s1.hasWheelEvent && i1(this, a)[a].addEventListener("wheel", this._onWheel, this.listenerOptions), s1.hasMouseWheelEvent && i1(this, a)[a].addEventListener("mousewheel", this._onMouseWheel, this.listenerOptions), s1.hasTouch && i1(this, r)[r].useTouch && (i1(this, a)[a].addEventListener("touchstart", this._onTouchStart, this.listenerOptions), i1(this, a)[a].addEventListener("touchmove", this._onTouchMove, this.listenerOptions)), s1.hasPointer && s1.hasTouchWin && (i1(this, d)[d] = document.body.style.msTouchAction, document.body.style.msTouchAction = "none", i1(this, a)[a].addEventListener("MSPointerDown", this._onTouchStart, !0), i1(this, a)[a].addEventListener("MSPointerMove", this._onTouchMove, !0)), s1.hasKeyDown && i1(this, r)[r].useKeyboard && document.addEventListener("keydown", this._onKeyDown);
        }, t2._unbind = function() {
            s1.hasWheelEvent && i1(this, a)[a].removeEventListener("wheel", this._onWheel), s1.hasMouseWheelEvent && i1(this, a)[a].removeEventListener("mousewheel", this._onMouseWheel), s1.hasTouch && (i1(this, a)[a].removeEventListener("touchstart", this._onTouchStart), i1(this, a)[a].removeEventListener("touchmove", this._onTouchMove)), s1.hasPointer && s1.hasTouchWin && (document.body.style.msTouchAction = i1(this, d)[d], i1(this, a)[a].removeEventListener("MSPointerDown", this._onTouchStart, !0), i1(this, a)[a].removeEventListener("MSPointerMove", this._onTouchMove, !0)), s1.hasKeyDown && i1(this, r)[r].useKeyboard && document.removeEventListener("keydown", this._onKeyDown);
        }, t2.on = function(e, t) {
            i1(this, l)[l].on(h1, e, t);
            var n = i1(this, l)[l].e;
            n && n[h1] && 1 === n[h1].length && this._bind();
        }, t2.off = function(e, t) {
            i1(this, l)[l].off(h1, e, t);
            var n = i1(this, l)[l].e;
            (!n[h1] || n[h1].length <= 0) && this._unbind();
        }, t2.destroy = function() {
            i1(this, l)[l].off(), this._unbind();
        }, e2;
    }();
});
